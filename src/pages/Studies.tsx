...
export default function Studies() {
  ...
  useSEO(contentSEO("Estudos bíblicos", `Literatura em destaque aplicada: ${study.title}. Encontre um tema e acompanhe a leitura bíblica.`, "/estudos"));
  ...
  return <ContentLayout>
    ...
    <div className="content-width catalog-body">
      ...
      {!query.trim() && <section className="study-series-feature" aria-labelledby="series-title"><img src={study.art480} srcSet={`${study.art480} 480w, ${study.art900} 900w`} sizes="(max-width: 720px) 90vw, 480px" alt={study.artAlt} width="480" height="854" /><div><h2 id="series-title">{study.title}</h2><p>{[study.subtitle, "Escola Bíblica"].filter(Boolean).join(" · ")}</p><a className="button button-blue" href="/blog">Conhecer a série <ArrowRight aria-hidden="true" /></a></div></section>}
